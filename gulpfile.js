...
import { phpfiles } from "./gulp/tasks/phpfiles.js";
...
function watcher() {
    ...
    gulp.watch(path.watch.phpfiles, phpfiles);
}
...
const mainTasks = gulp.series(fonts, gulp.parallel(copy, html, scss, js, images, videos, phpfiles, phpmailer, svgSprive));
